...
(function() {
  ...
  const translations = {
    zh: {
      ...
      'history-2004': '公司成立',
      'history-2005': '开展海外移植产品代理<br/>国内移植覆盖华东市场',
      'history-2008': '代理海正业务，扩展全国销售',
      ...
      'history-2023': 'G16 完成 FDA 注册',
      'history-2025': '莱拓低温冷藏箱<br/>通过 NMPA 注册',
    ...
    en: {
      ...
      'history-2005': 'Starting distribution of overseas transplant products<br/>Covering the transplant market in East China',
      'history-2008': 'Acting as Hisun exclusive distributor of immunosuppressant to expand national sales',
      ...
      'history-2023': 'Received FDA approval for G16',
      'history-2025': 'Received NMPA certification<br/>for Laituo static refrigeration box',
